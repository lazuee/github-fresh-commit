...
(() => {
	...
	var external_path_ = __nccwpck_require__(17); // CONCATENATED MODULE: external "url"
	const external_url_namespaceObject = __WEBPACK_EXTERNAL_createRequire(import.meta.url)("url"); // CONCATENATED MODULE: ./index.js
	...
	const main = async () => {
		...
		await exec(
			...
			[
				external_path_.join(
					external_path_.dirname((0, external_url_namespaceObject.fileURLToPath)(import.meta.url)),
					"..",
					"run.sh",
				),
			],
